...
<head>
    <meta charset="utf-8">
    <title>Terms of Service | Magnificent</title>
    ...
    <link rel="stylesheet" href="css/hdr-overlay.css">
    ...
    <div id="tos-text">
        ...
        <ol type="a">
            <li>
                ...
                (information or software) on Magnificent Technologies's web site for personal,
                ...
                <ol type="i">
                    ...
                    <li>attempt to decompile or reverse engineer any software contained on Magnificent Technologies's
                        web site;
                    </li>
            ...
            <li>
                ...
                terminated by Magnificent Technologies at any time. Upon terminating your viewing of these materials or
        ...
        <ol type="a">
            <li>
                The materials on Magnificent Technologies's web site are provided "as is". Magnificent Technologies
                ...
                Magnificent Technologies does not warrant or make any representations concerning the accuracy, likely
        ...
        <p>
            In no event shall Magnificent Technologies or its suppliers be liable for any damages (including, without
            limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or
            inability to use the materials on Magnificent Technologies's Internet site, even if Magnificent Technologies
            or a Magnificent Technologies authorized representative has been notified orally or in writing of the
        ...
        <p>
            The materials appearing on Magnificent Technologies's web site could include technical, typographical, or
            photographic errors. Magnificent Technologies does not warrant that any of the materials on its web site are
            accurate, complete, or current. Magnificent Technologies may make changes to the materials contained on its
            web site at any time without notice. Magnificent Technologies does not, however, make any commitment to
        ...
        <p>
            Magnificent Technologies has not reviewed all of the sites linked to its Internet web site and is not
            responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement
            by Magnificent Technologies of the site. Use of any such linked web site is at the user's own risk.
        </p>
        ...
        <p>
            Magnificent Technologies may revise these terms of use for its web site at any time without notice. By using
        ...
        <p>
            Any claim relating to Magnificent Technologies's web site shall be governed by the laws of the State of
